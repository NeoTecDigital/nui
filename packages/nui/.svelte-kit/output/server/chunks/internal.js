import { H as HYDRATION_ERROR, S as STATE_SYMBOL, U as UNINITIALIZED, B as BOUNDARY_EFFECT, E as ERROR_VALUE, a as EFFECT_RAN, b as UNOWNED, M as MAYBE_DIRTY, C as CLEAN, D as DERIVED, c as DEV, I as INERT, d as EFFECT, A as ASYNC, e as BLOCK_EFFECT, f as DIRTY, g as BRANCH_EFFECT, R as ROOT_EFFECT, h as DESTROYED, i as INSPECT_EFFECT, j as DISCONNECTED, k as REACTION_IS_UPDATING, l as STALE_REACTION, m as EFFECT_PRESERVED, n as HEAD_EFFECT, o as EFFECT_TRANSPARENT, p as USER_EFFECT, q as COMMENT_NODE, r as HYDRATION_START, s as HYDRATION_END, L as LEGACY_PROPS, t as render, u as push$1, v as pop$1, w as escape_html } from "./index.js";
import "clsx";
...
function Root($$payload, $$props) {
  ...
  if (mounted) {
    $$payload.out.push("<!--[-->");
    $$payload.out.push(`<div id="svelte-announcer" aria-live="assertive" aria-atomic="true" style="position: absolute; left: 0; top: 0; clip: rect(0 0 0 0); clip-path: inset(50%); overflow: hidden; white-space: nowrap; width: 1px; height: 1px">`);
    if (navigated) {
      $$payload.out.push("<!--[-->");
      $$payload.out.push(`${escape_html(title)}`);
    } else {
      $$payload.out.push("<!--[!-->");
    }
