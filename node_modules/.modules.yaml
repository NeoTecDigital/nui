...
hoistedDependencies:
  ...
  '@vitest/mocker@2.1.9(vite@5.4.20(@types/node@22.18.4))':
  ...
  vite-node@2.1.9(@types/node@22.18.4):
    vite-node: private
  vite@5.4.20(@types/node@22.18.4):
    vite: private
  which@2.0.2:
    which: private
...
pendingBuilds: []
prunedAt: Mon, 15 Sep 2025 20:14:21 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-x64-msvc@4.50.2'
  - fsevents@2.3.3
storeDir: /home/persist/.local/share/pnpm/store/v3
